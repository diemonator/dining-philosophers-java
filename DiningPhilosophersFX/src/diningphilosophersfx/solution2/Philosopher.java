...
public class Philosopher implements Runnable {
    ...
    private ChopstickMonitor m;

    public Philosopher(Chopstick right, Chopstick left, DiningPhilosophersFX dpfx, ChopstickMonitor m) {
